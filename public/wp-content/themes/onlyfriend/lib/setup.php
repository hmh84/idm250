...
function include_css_files() {
    ...
    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css2?family=Roboto:wght@400;900&display=swap');
    wp_enqueue_style('google-fonts2', 'https://fonts.googleapis.com/css2?family=Pacifico&display=swap');
...
function include_js_files() {
    ...
    wp_enqueue_script('jquery', get_template_directory_uri() . 'https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js', [], false, true);
}
